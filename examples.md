...
```bash
quick-cuts images/ -w "update" -o "C:\Users\lewis\aligned_outputs"
```

### 6. Performance Optimization
Use 16 workers for faster processing:
```bash
quick-cuts images/ -w "flash" --workers 16
```

### 7. Small Word Size
For subtle word placement:
```bash
quick-cuts images/ -w "live" --word-height 50
```
...
quick-cuts "news_screenshots/*.png" -w "breaking" -s 1920x1080 --word-height 120
```

### Social Media Clips
```bash
# Process vertical format for social media
quick-cuts tiktok_frames/ -w "viral" -s 1080x1920 --word-height 150
```
...
quick-cuts images/ -w "word" --workers 1
```
